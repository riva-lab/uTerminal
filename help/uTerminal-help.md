...
Для каждого принятого пакета данных можно добавить метку времени приема. Активировать эту опцию можно в настройках на вкладке `Прием`. Чтобы входящие данные были правильно разбиты на пакеты с метками, важно задать корректное значение таймаута пакета, т. е. интервала времени ожидания приема данных, по истечении которого пакет считается принятым.
