...
5. Предложите свой перевод на странице разработки проекта на [gitlab.com](https://gitlab.com/riva-lab/uterminal), открыв новый [вопрос](https://gitlab.com/riva-lab/uterminal/-/issues) с заголовком вида `i18n: language <your-locale> <new/fix/etc>`.
