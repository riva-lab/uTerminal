...
3. Еще раз исправлена ошибка с полосами прокрутки панели настроек плоттера.

---

### `v2.2.0.96` `2025.11.24`

1. Улучшена точность временной метки до миллисекунд.
2. Добавлены опции выбора элементов временной метки (дата, время, размер пакета).
3. Переделано сканирование портов.
4. Обновлена справка (раздел о временной метке).

---

### `v2.2.1.97` `2025.11.25`

1. Исправлено попадание на плоттер данных с временными метками.
2. Редизайн меню "Справка".
...
- [x] на плоттер попадают данные с временными метками – исправлено в v2.2.1.97
